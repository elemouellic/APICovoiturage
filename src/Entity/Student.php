...
class Student
{
    ...
    #[ORM\ManyToMany(targetEntity: Trip::class, inversedBy: 'participate')]
    private Collection $participate;

    #[ORM\OneToMany(targetEntity: trip::class, mappedBy: 'drive')]
    private Collection $drive;

    #[ORM\ManyToOne(inversedBy: 'live')]
